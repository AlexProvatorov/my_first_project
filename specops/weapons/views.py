...
#     return render(request, 'weapons/index.html',context=context)
...
#     else:
#         form = AddPostForm()
#     return render(request, 'weapons/addpage.html', {'form': form, 'menu': menu, 'title': 'Добавление статьи'})
...
#     post = get_object_or_404(Weapon,    slug=post_slug)
...
#     return render(request, 'weapons/post.html', context=context)
...
#     posts = Weapon.objects.filter(cat_id=cat_id)
#     if len(posts) == 0:
#         raise Http404()
